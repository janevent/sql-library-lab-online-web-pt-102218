...
def select_character_names_and_number_of_books_they_are_in
  "SELECT character.name, COUNT(character_books.book_id) FROM characters JOIN character_books ON character.id = character_books.character_id GROUP BY character.name;"
end
